...
public abstract class RelationalDatabaseCreator : IRelationalDatabaseCreator
{
    ...
    public virtual void CreateTables()
        => Dependencies.MigrationCommandExecutor.ExecuteNonQuery(GetCreateTablesCommands(), Dependencies.Connection, new MigrationExecutionState(), useExecutionStrategy: true);
    ...
    public virtual Task CreateTablesAsync(CancellationToken cancellationToken = default)
        => Dependencies.MigrationCommandExecutor.ExecuteNonQueryAsync(
            GetCreateTablesCommands(), Dependencies.Connection, new MigrationExecutionState(), useExecutionStrategy: true, cancellationToken);
